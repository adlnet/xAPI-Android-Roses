...
public class SymbolismActivity extends ContentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (attemptId == null){
            ...
            Activity init_act = createActivity(getString(R.string.app_activity_iri) + getString(R.string.mod_symbolism_path),
                    getString(R.string.mod_symbolism_name), getString(R.string.mod_symbolism_description), getString(R.string.scorm_profile_activity_type_lesson_id));
            Activity attempt_act = createActivity(getString(R.string.app_activity_iri) + getString(R.string.mod_symbolism_path)
                    +"?attemptId=" + getCurrentAttempt(), "Attempt for " + getString(R.string.mod_symbolism_name),
                    "Attempt for " + getString(R.string.mod_symbolism_description), getString(R.string.scorm_profile_activity_type_attempt_id));
        ...
        Button button = (Button) findViewById(R.id.symSuspend);
        ...
        Button pbutton = (Button) findViewById(R.id.symPrev);
        ...
        Button nbutton = (Button) findViewById(R.id.symNext);
