...
public class FloristryActivity extends ContentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (attemptId == null){
            ...
            Activity init_act = createActivity(getString(R.string.app_activity_iri) + getString(R.string.mod_styles_path),
                    getString(R.string.mod_styles_name), getString(R.string.mod_styles_description), getString(R.string.scorm_profile_activity_type_lesson_id));
            Activity attempt_act = createActivity(getString(R.string.app_activity_iri) + getString(R.string.mod_styles_path)
                    +"?attemptId=" + getCurrentAttempt(), "Attempt for " + getString(R.string.mod_styles_name),
                    "Attempt for " + getString(R.string.mod_styles_description), getString(R.string.scorm_profile_activity_type_attempt_id));
