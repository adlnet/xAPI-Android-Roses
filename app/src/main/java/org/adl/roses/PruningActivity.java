    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (attemptId == null){
            ...
            Activity init_act = createActivity(getString(R.string.app_activity_iri) + getString(R.string.mod_pruning_path),
                    getString(R.string.mod_pruning_name), getString(R.string.mod_pruning_description), getString(R.string.scorm_profile_activity_type_lesson_id));
            Activity attempt_act = createActivity(getString(R.string.app_activity_iri) + getString(R.string.mod_pruning_path)
                    +"?attemptId=" + getCurrentAttempt(), "Attempt for " + getString(R.string.mod_pruning_name),
                    "Attempt for " + getString(R.string.mod_pruning_description), getString(R.string.scorm_profile_activity_type_attempt_id));
        ...
        Button button = (Button) findViewById(R.id.prunSuspend);
        ...
        Button pbutton = (Button) findViewById(R.id.prunPrev);
        ...
        Button nbutton = (Button) findViewById(R.id.prunNext);
